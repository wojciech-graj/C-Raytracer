...
#define NUM_SCENE_ELEM_TYPES 9
#define NUM_CAMERA_ELEMS 3
#define NUM_OBJECT_ELEMS 7
...
enum scene_elems{CAMERA, SPHERE, TRIANGLE, PLANE, MESH, LIGHT, AMBIENTLIGHT, EPSILON, LIGHTAREA};
enum camera_elems{CAMERA_POSITION, CAMERA_VECTOR1, CAMERA_VECTOR2};
enum object_elems{OBJECT_KS, OBJECT_KD, OBJECT_KA, OBJECT_KR, OBJECT_KT, OBJECT_SHININESS, OBJECT_REFRACTIVE_INDEX};
